...
const LEVELS = [
	...
	{"name": "코스닥", "radius": 72, "color": Color(0.25, 0.78, 0.78), "highlight": Color(0.45, 0.92, 0.92), "score": 28, "label": "100억", "emoji": "📊"},
	{"name": "코스피", "radius": 80, "color": Color(0.22, 0.55, 0.95), "highlight": Color(0.45, 0.72, 1.0), "score": 36, "label": "1000억", "emoji": "🏢"},
	{"name": "대기업", "radius": 90, "color": Color(0.85, 0.28, 0.28), "highlight": Color(1.0, 0.45, 0.45), "score": 45, "label": "1조", "emoji": "🏭"},
	{"name": "삼성전자", "radius": 100, "color": Color(1.0, 0.82, 0.0), "highlight": Color(1.0, 0.92, 0.4), "score": 55, "label": "10조", "emoji": "👑"},
]
